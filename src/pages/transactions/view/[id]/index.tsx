...
import { BrokerageListPage } from 'pages/brokerages';
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Script Name" text={data?.script_name} />

                <FormListItem label="Buy Price" text={data?.buy_price} />

                <FormListItem label="Sell Price" text={data?.sell_price} />

                <FormListItem label="Buy Qty" text={data?.buy_qty} />

                <FormListItem label="Sell Qty" text={data?.sell_qty} />
