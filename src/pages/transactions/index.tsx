...
export function TransactionListPage(props: TransactionListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTransactions({
        relations: ['organization', 'brokerage.count', 'note.count', 'position.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['script_name.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'script_name', header: 'Script Name', accessorKey: 'script_name' },
    { id: 'buy_price', header: 'buy_price', accessorKey: 'buy_price' },
    { id: 'sell_price', header: 'sell_price', accessorKey: 'sell_price' },
    { id: 'buy_qty', header: 'buy_qty', accessorKey: 'buy_qty' },
    { id: 'sell_qty', header: 'sell_qty', accessorKey: 'sell_qty' },
    ...
    hasAccess('brokerage', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.brokerage,
        }
      : null,
