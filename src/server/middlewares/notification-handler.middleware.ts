...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'transaction.create': {
    roles: ['administrator', 'financial-analyst'],
    key: 'new-transaction',
    tenantPath: ['organization', 'transaction'],
    userPath: [],
  },
  'transaction.update': {
    roles: ['trader', 'financial-analyst'],
  ...
  'note.create': {
    roles: ['trader'],
    key: 'new-note',
    tenantPath: ['organization', 'transaction', 'note'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['administrator', 'financial-analyst', 'trader'];
